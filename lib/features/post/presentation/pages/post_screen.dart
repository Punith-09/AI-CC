...
import '../widgets/post_skill_tag.dart';
...
class _PostScreenState extends State<PostScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color(0xFF1C5260),
      // appBar: AppBar(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Wrap(
                    ...
                    runSpacing: 10,
                    children: [
                      // const PostSkillTag(title: "Classical Dance", selected: true),
                      const PostSkillTag(title: "Method Acting", selected: false),
                      const PostSkillTag(title: "Stunt Work", selected: false),
                      const PostSkillTag(title: "Singing", selected: true),
                      const PostSkillTag(title: "Dialect Coach", selected: false),
                      const PostSkillTag(title: "Martial Arts", selected: false),
                      const PostSkillTag(title: "Swimming", selected: false),
                      DottedBorder(
                        borderType: BorderType.RRect,
